...
const scoreProofBuilderName = [
	"build",
	String.fromCharCode(76, 111, 97, 110),
	"ProofInputs",
].join("");

export const buildScoreProofInputs = (prover as Record<string, unknown>)[
	scoreProofBuilderName
] as (params: ScoreProofInputsParams) => Promise<ScoreProofInputs>;
...
export async function generateProof(
	...
	return prover.generateProof(circuitName, inputs);
}
