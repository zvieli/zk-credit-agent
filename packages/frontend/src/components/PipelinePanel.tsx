					...
					scoreInputs ? (
						<div className="metrics">
							...
							<div>
								...
								<strong>
									{String(scoreInputs.metadata.stateRoot).slice(0, 10) +
										"…" +
										String(scoreInputs.metadata.stateRoot).slice(-8)}
								</strong>
							</div>
							<div>
					...
					axiomDispatch ? (
						<div className="metrics">
							...
							<div>
								...
								<strong>
									{axiomDispatch.queryHash
										? axiomDispatch.queryHash.slice(0, 10) +
											"…" +
											axiomDispatch.queryHash.slice(-8)
										: "pending"}
								</strong>
							</div>
						</div>
					...
					combinedProof ? (
						<div className="metrics">
							<div>
								...
								<strong>
									{combinedProof.proof
										? combinedProof.proof.slice(0, 10) +
											"…" +
											combinedProof.proof.slice(-8)
										: "not ready"}
								</strong>
							</div>
							<div>
