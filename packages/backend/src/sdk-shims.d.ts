...
declare module '@aztec/bb.js' {
  ...
  export class Barretenberg {
    static new(options?: { backend?: BackendType; threads?: number }): Promise<Barretenberg>;
    destroy(): Promise<void>;
  }

  export class UltraHonkBackend {
    constructor(acirBytecode: string, api: Barretenberg);
    generateProof(compressedWitness: Uint8Array, options?: { verifierTarget?: 'evm' | 'evm-no-zk' }): Promise<{
      proof: Uint8Array;
      publicInputs: string[];
    }>;
  }
